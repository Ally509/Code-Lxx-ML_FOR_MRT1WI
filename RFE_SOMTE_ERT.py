...
def run(seed, X1, y1):
    ...
    # #
    # # print("the number of x_over:",x_over.shape)
    # # print("the number of y_over:", y_over.shape)
    # #
    # # ratio0 = sum(y_over==0)/sum(y_over==1)
    # # print('In Training set,train_0:train_1={:}:{:}={:.2f}'.format(sum(y_over==0),sum(y_over==1),ratio0))
    #
    ...
    # print('In Testing set,test_0:test_1={:}:{:}={:.2f}'.format(sum(y_test==0),sum(y_test==1),ratio2))
